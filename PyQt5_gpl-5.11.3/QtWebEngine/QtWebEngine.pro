...
win32 {
    PY_MODULE = QtWebEngine.pyd
    PY_MODULE_SRC = $(DESTDIR_TARGET)
} else {
    PY_MODULE = QtWebEngine.so
...
HEADERS = sipAPIQtWebEngine.h
SOURCES = sipQtWebEngineQQuickWebEngineProfile.cpp sipQtWebEngineQQuickWebEngineScript.cpp sipQtWebEngineQtWebEngine.cpp sipQtWebEnginecmodule.cpp
