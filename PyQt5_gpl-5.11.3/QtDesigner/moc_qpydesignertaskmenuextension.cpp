...
QT_INIT_METAOBJECT const QMetaObject QPyDesignerTaskMenuExtension::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QPyDesignerTaskMenuExtension.data,
    qt_meta_data_QPyDesignerTaskMenuExtension,
    qt_static_metacall,
    nullptr,
    nullptr
} };
