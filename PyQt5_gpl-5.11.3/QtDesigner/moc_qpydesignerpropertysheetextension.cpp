...
QT_INIT_METAOBJECT const QMetaObject QPyDesignerPropertySheetExtension::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QPyDesignerPropertySheetExtension.data,
    qt_meta_data_QPyDesignerPropertySheetExtension,
    qt_static_metacall,
    nullptr,
    nullptr
} };
