...
#line 29 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtCore/sipQtCoreQElapsedTimer.cpp"
...
static sipEnumMemberDef enummembers_QElapsedTimer[] = {
    {sipName_MachAbsoluteTime, static_cast<int>( ::QElapsedTimer::MachAbsoluteTime), 60},
    {sipName_MonotonicClock, static_cast<int>( ::QElapsedTimer::MonotonicClock), 60},
    {sipName_PerformanceCounter, static_cast<int>( ::QElapsedTimer::PerformanceCounter), 60},
    {sipName_SystemTime, static_cast<int>( ::QElapsedTimer::SystemTime), 60},
    {sipName_TickCounter, static_cast<int>( ::QElapsedTimer::TickCounter), 60},
};
