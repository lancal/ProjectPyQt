...
#line 29 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtCore/sipQtCoreQJsonParseError.cpp"

#line 27 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtCore/sipQtCoreQJsonParseError.cpp"
...
static sipEnumMemberDef enummembers_QJsonParseError[] = {
    {sipName_DeepNesting, static_cast<int>( ::QJsonParseError::DeepNesting), 102},
    {sipName_DocumentTooLarge, static_cast<int>( ::QJsonParseError::DocumentTooLarge), 102},
    {sipName_GarbageAtEnd, static_cast<int>( ::QJsonParseError::GarbageAtEnd), 102},
    {sipName_IllegalEscapeSequence, static_cast<int>( ::QJsonParseError::IllegalEscapeSequence), 102},
    {sipName_IllegalNumber, static_cast<int>( ::QJsonParseError::IllegalNumber), 102},
    {sipName_IllegalUTF8String, static_cast<int>( ::QJsonParseError::IllegalUTF8String), 102},
    {sipName_IllegalValue, static_cast<int>( ::QJsonParseError::IllegalValue), 102},
    {sipName_MissingNameSeparator, static_cast<int>( ::QJsonParseError::MissingNameSeparator), 102},
    {sipName_MissingObject, static_cast<int>( ::QJsonParseError::MissingObject), 102},
    {sipName_MissingValueSeparator, static_cast<int>( ::QJsonParseError::MissingValueSeparator), 102},
    {sipName_NoError, static_cast<int>( ::QJsonParseError::NoError), 102},
    {sipName_TerminationByNumber, static_cast<int>( ::QJsonParseError::TerminationByNumber), 102},
    {sipName_UnterminatedArray, static_cast<int>( ::QJsonParseError::UnterminatedArray), 102},
    {sipName_UnterminatedObject, static_cast<int>( ::QJsonParseError::UnterminatedObject), 102},
    {sipName_UnterminatedString, static_cast<int>( ::QJsonParseError::UnterminatedString), 102},
};
