...
#line 29 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtPositioning/sipQtPositioningQGeoSatelliteInfo.cpp"
...
static sipEnumMemberDef enummembers_QGeoSatelliteInfo[] = {
    {sipName_Azimuth, static_cast<int>( ::QGeoSatelliteInfo::Azimuth), 21},
    {sipName_Elevation, static_cast<int>( ::QGeoSatelliteInfo::Elevation), 21},
    {sipName_GLONASS, static_cast<int>( ::QGeoSatelliteInfo::GLONASS), 22},
    {sipName_GPS, static_cast<int>( ::QGeoSatelliteInfo::GPS), 22},
    {sipName_Undefined, static_cast<int>( ::QGeoSatelliteInfo::Undefined), 22},
};
