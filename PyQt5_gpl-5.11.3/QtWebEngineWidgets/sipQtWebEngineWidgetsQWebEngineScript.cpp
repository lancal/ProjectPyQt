...
#line 29 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtWebEngineWidgets/sipQtWebEngineWidgetsQWebEngineScript.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtWebEngineWidgets/sipQtWebEngineWidgetsQWebEngineScript.cpp"
...
static PyObject *meth_QWebEngineScript_injectionPoint(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_QWebEngineScript, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_QWebEngineScript_InjectionPoint);
        }
    }
...
extern "C" {static void assign_QWebEngineScript(void *, SIP_SSIZE_T, void *);}
static void assign_QWebEngineScript(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QWebEngineScript *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QWebEngineScript *>(sipSrc);
}
...
static sipEnumMemberDef enummembers_QWebEngineScript[] = {
    {sipName_ApplicationWorld, static_cast<int>( ::QWebEngineScript::ApplicationWorld), 34},
    {sipName_Deferred, static_cast<int>( ::QWebEngineScript::Deferred), 33},
    {sipName_DocumentCreation, static_cast<int>( ::QWebEngineScript::DocumentCreation), 33},
    {sipName_DocumentReady, static_cast<int>( ::QWebEngineScript::DocumentReady), 33},
    {sipName_MainWorld, static_cast<int>( ::QWebEngineScript::MainWorld), 34},
    {sipName_UserWorld, static_cast<int>( ::QWebEngineScript::UserWorld), 34},
};
...
static pyqt5ClassPluginDef plugin_QWebEngineScript = {
    0,
    0,
    0,
    0
...
sipClassTypeDef sipTypeDef_QtWebEngineWidgets_QWebEngineScript = {
    {
        -1,
        0,
        0,
