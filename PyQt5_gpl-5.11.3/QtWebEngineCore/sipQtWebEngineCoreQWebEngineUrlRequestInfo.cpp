...
#line 29 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtWebEngineCore/sipQtWebEngineCoreQWebEngineUrlRequestInfo.cpp"

#line 30 "sip/QtCore/qbytearray.sip"
#include <qbytearray.h>
#line 33 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtWebEngineCore/sipQtWebEngineCoreQWebEngineUrlRequestInfo.cpp"
#line 96 "sip/QtCore/qurl.sip"
#include <qurl.h>
#line 36 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtWebEngineCore/sipQtWebEngineCoreQWebEngineUrlRequestInfo.cpp"
...
static PyObject *meth_QWebEngineUrlRequestInfo_resourceType(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_QWebEngineUrlRequestInfo, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_QWebEngineUrlRequestInfo_ResourceType);
        }
    }
...
static PyObject *meth_QWebEngineUrlRequestInfo_navigationType(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_QWebEngineUrlRequestInfo, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_QWebEngineUrlRequestInfo_NavigationType);
        }
    }
...
static sipEnumMemberDef enummembers_QWebEngineUrlRequestInfo[] = {
    {sipName_NavigationTypeBackForward, static_cast<int>( ::QWebEngineUrlRequestInfo::NavigationTypeBackForward), 9},
    {sipName_NavigationTypeFormSubmitted, static_cast<int>( ::QWebEngineUrlRequestInfo::NavigationTypeFormSubmitted), 9},
    {sipName_NavigationTypeLink, static_cast<int>( ::QWebEngineUrlRequestInfo::NavigationTypeLink), 9},
    {sipName_NavigationTypeOther, static_cast<int>( ::QWebEngineUrlRequestInfo::NavigationTypeOther), 9},
    {sipName_NavigationTypeReload, static_cast<int>( ::QWebEngineUrlRequestInfo::NavigationTypeReload), 9},
    {sipName_NavigationTypeTyped, static_cast<int>( ::QWebEngineUrlRequestInfo::NavigationTypeTyped), 9},
    {sipName_ResourceTypeCspReport, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeCspReport), 10},
    {sipName_ResourceTypeFavicon, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeFavicon), 10},
    {sipName_ResourceTypeFontResource, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeFontResource), 10},
    {sipName_ResourceTypeImage, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeImage), 10},
    {sipName_ResourceTypeMainFrame, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeMainFrame), 10},
    {sipName_ResourceTypeMedia, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeMedia), 10},
    {sipName_ResourceTypeObject, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeObject), 10},
    {sipName_ResourceTypePing, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypePing), 10},
    {sipName_ResourceTypePluginResource, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypePluginResource), 10},
    {sipName_ResourceTypePrefetch, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypePrefetch), 10},
    {sipName_ResourceTypeScript, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeScript), 10},
    {sipName_ResourceTypeServiceWorker, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeServiceWorker), 10},
    {sipName_ResourceTypeSharedWorker, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeSharedWorker), 10},
    {sipName_ResourceTypeStylesheet, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeStylesheet), 10},
    {sipName_ResourceTypeSubFrame, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeSubFrame), 10},
    {sipName_ResourceTypeSubResource, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeSubResource), 10},
    {sipName_ResourceTypeUnknown, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeUnknown), 10},
    {sipName_ResourceTypeWorker, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeWorker), 10},
    {sipName_ResourceTypeXhr, static_cast<int>( ::QWebEngineUrlRequestInfo::ResourceTypeXhr), 10},
};


static pyqt5ClassPluginDef plugin_QWebEngineUrlRequestInfo = {
    0,
    0,
    0,
    0
...
sipClassTypeDef sipTypeDef_QtWebEngineCore_QWebEngineUrlRequestInfo = {
    {
        -1,
        0,
        0,
        ...
        {0},
        &plugin_QWebEngineUrlRequestInfo
    },
    {
        sipNameNr_QWebEngineUrlRequestInfo,
        {0, 0, 1},
