...
#line 29 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtLocation/sipQtLocationQGeoManeuver.cpp"

#line 24 "sip/QtCore/qpycore_qvariantmap.sip"
#include <qvariant.h>
#line 33 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtLocation/sipQtLocationQGeoManeuver.cpp"
#line 28 "sip/QtPositioning/qgeocoordinate.sip"
#include <qgeocoordinate.h>
#line 36 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtLocation/sipQtLocationQGeoManeuver.cpp"
#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 39 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtLocation/sipQtLocationQGeoManeuver.cpp"
...
static PyObject *meth_QGeoManeuver_direction(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_QGeoManeuver, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_QGeoManeuver_InstructionDirection);
        }
    }
...
PyDoc_STRVAR(doc_QGeoManeuver_setExtendedAttributes, "setExtendedAttributes(self, Dict[str, Any])");

extern "C" {static PyObject *meth_QGeoManeuver_setExtendedAttributes(PyObject *, PyObject *);}
static PyObject *meth_QGeoManeuver_setExtendedAttributes(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ1", &sipSelf, sipType_QGeoManeuver, &sipCpp, sipType_QVariantMap,&a0, &a0State))
        {
            sipCpp->setExtendedAttributes(*a0);
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QGeoManeuver, sipName_setExtendedAttributes, doc_QGeoManeuver_setExtendedAttributes);

    return NULL;
}


PyDoc_STRVAR(doc_QGeoManeuver_extendedAttributes, "extendedAttributes(self) -> Dict[str, Any]");

extern "C" {static PyObject *meth_QGeoManeuver_extendedAttributes(PyObject *, PyObject *);}
static PyObject *meth_QGeoManeuver_extendedAttributes(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_QGeoManeuver, &sipCpp))
        {
            ...
            sipRes = new  ::QVariantMap(sipCpp->extendedAttributes());
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QGeoManeuver, sipName_extendedAttributes, doc_QGeoManeuver_extendedAttributes);
...
extern "C" {static void assign_QGeoManeuver(void *, SIP_SSIZE_T, void *);}
static void assign_QGeoManeuver(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QGeoManeuver *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QGeoManeuver *>(sipSrc);
}
...
static PyMethodDef methods_QGeoManeuver[] = {
    ...
    {SIP_MLNAME_CAST(sipName_extendedAttributes), meth_QGeoManeuver_extendedAttributes, METH_VARARGS, SIP_MLDOC_CAST(doc_QGeoManeuver_extendedAttributes)},
    ...
    {SIP_MLNAME_CAST(sipName_setExtendedAttributes), meth_QGeoManeuver_setExtendedAttributes, METH_VARARGS, SIP_MLDOC_CAST(doc_QGeoManeuver_setExtendedAttributes)},
...
static pyqt5ClassPluginDef plugin_QGeoManeuver = {
    0,
    0,
    0,
    0
...
sipClassTypeDef sipTypeDef_QtLocation_QGeoManeuver = {
    {
        -1,
        0,
        0,
