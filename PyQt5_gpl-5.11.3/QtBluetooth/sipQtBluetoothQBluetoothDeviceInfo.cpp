...
#line 29 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"

#line 28 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/sip/QtBluetooth/qbluetoothaddress.sip"
#include <qbluetoothaddress.h>
#line 33 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 36 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 28 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/sip/QtBluetooth/qbluetoothuuid.sip"
#include <qbluetoothuuid.h>
#line 39 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 28 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/sip/QtBluetooth/qbluetoothdeviceinfo.sip"
#include <qbluetoothdeviceinfo.h>
#line 42 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 38 "sip/QtCore/qpycore_qlist.sip"
#include <qlist.h>
#line 45 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
#line 28 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/sip/QtBluetooth/qbluetoothdeviceinfo.sip"
#include <qbluetoothdeviceinfo.h>
#line 48 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtBluetooth/sipQtBluetoothQBluetoothDeviceInfo.cpp"
...
static sipEnumMemberDef enummembers_QBluetoothDeviceInfo[] = {
    {sipName_AllServices, static_cast<int>( ::QBluetoothDeviceInfo::AllServices), 26},
    {sipName_AudioService, static_cast<int>( ::QBluetoothDeviceInfo::AudioService), 26},
    {sipName_AudioVideoDevice, static_cast<int>( ::QBluetoothDeviceInfo::AudioVideoDevice), 15},
    ...
    {sipName_Camcorder, static_cast<int>( ::QBluetoothDeviceInfo::Camcorder), 16},
    {sipName_CapturingService, static_cast<int>( ::QBluetoothDeviceInfo::CapturingService), 26},
    {sipName_CarAudio, static_cast<int>( ::QBluetoothDeviceInfo::CarAudio), 16},
    {sipName_CardReaderPeripheral, static_cast<int>( ::QBluetoothDeviceInfo::CardReaderPeripheral), 22},
    {sipName_CellularPhone, static_cast<int>( ::QBluetoothDeviceInfo::CellularPhone), 23},
    {sipName_CommonIsdnAccessPhone, static_cast<int>( ::QBluetoothDeviceInfo::CommonIsdnAccessPhone), 23},
    {sipName_ComputerDevice, static_cast<int>( ::QBluetoothDeviceInfo::ComputerDevice), 15},
    {sipName_CordlessPhone, static_cast<int>( ::QBluetoothDeviceInfo::CordlessPhone), 23},
    ...
    {sipName_DesktopComputer, static_cast<int>( ::QBluetoothDeviceInfo::DesktopComputer), 17},
    {sipName_DigitizerTabletPeripheral, static_cast<int>( ::QBluetoothDeviceInfo::DigitizerTabletPeripheral), 22},
    {sipName_GamepadPeripheral, static_cast<int>( ::QBluetoothDeviceInfo::GamepadPeripheral), 22},
    {sipName_GamingDevice, static_cast<int>( ::QBluetoothDeviceInfo::GamingDevice), 16},
    {sipName_HandheldClamShellComputer, static_cast<int>( ::QBluetoothDeviceInfo::HandheldClamShellComputer), 17},
    {sipName_HandheldComputer, static_cast<int>( ::QBluetoothDeviceInfo::HandheldComputer), 17},
    {sipName_HandsFreeDevice, static_cast<int>( ::QBluetoothDeviceInfo::HandsFreeDevice), 16},
    {sipName_Headphones, static_cast<int>( ::QBluetoothDeviceInfo::Headphones), 16},
    {sipName_HealthBloodPressureMonitor, static_cast<int>( ::QBluetoothDeviceInfo::HealthBloodPressureMonitor), 18},
    {sipName_HealthDataDisplay, static_cast<int>( ::QBluetoothDeviceInfo::HealthDataDisplay), 18},
    {sipName_HealthDevice, static_cast<int>( ::QBluetoothDeviceInfo::HealthDevice), 15},
    {sipName_HealthGlucoseMeter, static_cast<int>( ::QBluetoothDeviceInfo::HealthGlucoseMeter), 18},
    {sipName_HealthPulseOximeter, static_cast<int>( ::QBluetoothDeviceInfo::HealthPulseOximeter), 18},
    {sipName_HealthStepCounter, static_cast<int>( ::QBluetoothDeviceInfo::HealthStepCounter), 18},
    {sipName_HealthThermometer, static_cast<int>( ::QBluetoothDeviceInfo::HealthThermometer), 18},
    {sipName_HealthWeightScale, static_cast<int>( ::QBluetoothDeviceInfo::HealthWeightScale), 18},
    {sipName_HiFiAudioDevice, static_cast<int>( ::QBluetoothDeviceInfo::HiFiAudioDevice), 16},
    {sipName_ImageCamera, static_cast<int>( ::QBluetoothDeviceInfo::ImageCamera), 19},
    {sipName_ImageDisplay, static_cast<int>( ::QBluetoothDeviceInfo::ImageDisplay), 19},
    {sipName_ImagePrinter, static_cast<int>( ::QBluetoothDeviceInfo::ImagePrinter), 19},
    {sipName_ImageScanner, static_cast<int>( ::QBluetoothDeviceInfo::ImageScanner), 19},
    {sipName_ImagingDevice, static_cast<int>( ::QBluetoothDeviceInfo::ImagingDevice), 15},
    {sipName_InformationService, static_cast<int>( ::QBluetoothDeviceInfo::InformationService), 26},
    {sipName_JoystickPeripheral, static_cast<int>( ::QBluetoothDeviceInfo::JoystickPeripheral), 22},
    {sipName_KeyboardPeripheral, static_cast<int>( ::QBluetoothDeviceInfo::KeyboardPeripheral), 22},
    {sipName_KeyboardWithPointingDevicePeripheral, static_cast<int>( ::QBluetoothDeviceInfo::KeyboardWithPointingDevicePeripheral), 22},
    {sipName_LANAccessDevice, static_cast<int>( ::QBluetoothDeviceInfo::LANAccessDevice), 15},
    {sipName_LaptopComputer, static_cast<int>( ::QBluetoothDeviceInfo::LaptopComputer), 17},
    {sipName_Loudspeaker, static_cast<int>( ::QBluetoothDeviceInfo::Loudspeaker), 16},
    {sipName_LowEnergyCoreConfiguration, static_cast<int>( ::QBluetoothDeviceInfo::LowEnergyCoreConfiguration), 12},
    {sipName_Microphone, static_cast<int>( ::QBluetoothDeviceInfo::Microphone), 16},
    {sipName_MiscellaneousDevice, static_cast<int>( ::QBluetoothDeviceInfo::MiscellaneousDevice), 15},
    {sipName_NetworkFullService, static_cast<int>( ::QBluetoothDeviceInfo::NetworkFullService), 21},
    {sipName_NetworkLoadFactorFive, static_cast<int>( ::QBluetoothDeviceInfo::NetworkLoadFactorFive), 21},
    {sipName_NetworkLoadFactorFour, static_cast<int>( ::QBluetoothDeviceInfo::NetworkLoadFactorFour), 21},
    {sipName_NetworkLoadFactorOne, static_cast<int>( ::QBluetoothDeviceInfo::NetworkLoadFactorOne), 21},
    {sipName_NetworkLoadFactorSix, static_cast<int>( ::QBluetoothDeviceInfo::NetworkLoadFactorSix), 21},
    {sipName_NetworkLoadFactorThree, static_cast<int>( ::QBluetoothDeviceInfo::NetworkLoadFactorThree), 21},
    {sipName_NetworkLoadFactorTwo, static_cast<int>( ::QBluetoothDeviceInfo::NetworkLoadFactorTwo), 21},
    {sipName_NetworkNoService, static_cast<int>( ::QBluetoothDeviceInfo::NetworkNoService), 21},
    {sipName_NetworkingService, static_cast<int>( ::QBluetoothDeviceInfo::NetworkingService), 26},
    {sipName_NoService, static_cast<int>( ::QBluetoothDeviceInfo::NoService), 26},
    {sipName_ObjectTransferService, static_cast<int>( ::QBluetoothDeviceInfo::ObjectTransferService), 26},
    {sipName_PeripheralDevice, static_cast<int>( ::QBluetoothDeviceInfo::PeripheralDevice), 15},
    {sipName_PhoneDevice, static_cast<int>( ::QBluetoothDeviceInfo::PhoneDevice), 15},
    {sipName_PointingDevicePeripheral, static_cast<int>( ::QBluetoothDeviceInfo::PointingDevicePeripheral), 22},
    {sipName_PortableAudioDevice, static_cast<int>( ::QBluetoothDeviceInfo::PortableAudioDevice), 16},
    {sipName_PositioningService, static_cast<int>( ::QBluetoothDeviceInfo::PositioningService), 26},
    {sipName_RemoteControlPeripheral, static_cast<int>( ::QBluetoothDeviceInfo::RemoteControlPeripheral), 22},
    {sipName_RenderingService, static_cast<int>( ::QBluetoothDeviceInfo::RenderingService), 26},
    {sipName_SensingDevicePeripheral, static_cast<int>( ::QBluetoothDeviceInfo::SensingDevicePeripheral), 22},
    {sipName_ServerComputer, static_cast<int>( ::QBluetoothDeviceInfo::ServerComputer), 17},
    {sipName_SetTopBox, static_cast<int>( ::QBluetoothDeviceInfo::SetTopBox), 16},
    {sipName_SmartPhone, static_cast<int>( ::QBluetoothDeviceInfo::SmartPhone), 23},
    {sipName_TelephonyService, static_cast<int>( ::QBluetoothDeviceInfo::TelephonyService), 26},
    {sipName_ToyController, static_cast<int>( ::QBluetoothDeviceInfo::ToyController), 24},
    {sipName_ToyDevice, static_cast<int>( ::QBluetoothDeviceInfo::ToyDevice), 15},
    {sipName_ToyDoll, static_cast<int>( ::QBluetoothDeviceInfo::ToyDoll), 24},
    {sipName_ToyGame, static_cast<int>( ::QBluetoothDeviceInfo::ToyGame), 24},
    {sipName_ToyRobot, static_cast<int>( ::QBluetoothDeviceInfo::ToyRobot), 24},
    {sipName_ToyVehicle, static_cast<int>( ::QBluetoothDeviceInfo::ToyVehicle), 24},
    {sipName_UncategorizedAudioVideoDevice, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedAudioVideoDevice), 16},
    {sipName_UncategorizedComputer, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedComputer), 17},
    {sipName_UncategorizedDevice, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedDevice), 15},
    {sipName_UncategorizedHealthDevice, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedHealthDevice), 18},
    {sipName_UncategorizedImagingDevice, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedImagingDevice), 19},
    {sipName_UncategorizedMiscellaneous, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedMiscellaneous), 20},
    {sipName_UncategorizedPeripheral, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedPeripheral), 22},
    {sipName_UncategorizedPhone, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedPhone), 23},
    {sipName_UncategorizedToy, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedToy), 24},
    {sipName_UncategorizedWearableDevice, static_cast<int>( ::QBluetoothDeviceInfo::UncategorizedWearableDevice), 25},
    {sipName_UnknownCoreConfiguration, static_cast<int>( ::QBluetoothDeviceInfo::UnknownCoreConfiguration), 12},
    {sipName_Vcr, static_cast<int>( ::QBluetoothDeviceInfo::Vcr), 16},
    {sipName_VideoCamera, static_cast<int>( ::QBluetoothDeviceInfo::VideoCamera), 16},
    {sipName_VideoConferencing, static_cast<int>( ::QBluetoothDeviceInfo::VideoConferencing), 16},
    {sipName_VideoDisplayAndLoudspeaker, static_cast<int>( ::QBluetoothDeviceInfo::VideoDisplayAndLoudspeaker), 16},
    {sipName_VideoMonitor, static_cast<int>( ::QBluetoothDeviceInfo::VideoMonitor), 16},
    {sipName_WearableComputer, static_cast<int>( ::QBluetoothDeviceInfo::WearableComputer), 17},
    {sipName_WearableDevice, static_cast<int>( ::QBluetoothDeviceInfo::WearableDevice), 15},
    {sipName_WearableGlasses, static_cast<int>( ::QBluetoothDeviceInfo::WearableGlasses), 25},
    {sipName_WearableHeadsetDevice, static_cast<int>( ::QBluetoothDeviceInfo::WearableHeadsetDevice), 16},
    {sipName_WearableHelmet, static_cast<int>( ::QBluetoothDeviceInfo::WearableHelmet), 25},
    {sipName_WearableJacket, static_cast<int>( ::QBluetoothDeviceInfo::WearableJacket), 25},
    {sipName_WearablePager, static_cast<int>( ::QBluetoothDeviceInfo::WearablePager), 25},
    {sipName_WearableWristWatch, static_cast<int>( ::QBluetoothDeviceInfo::WearableWristWatch), 25},
    {sipName_WiredModemOrVoiceGatewayPhone, static_cast<int>( ::QBluetoothDeviceInfo::WiredModemOrVoiceGatewayPhone), 23},
};
