...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PyCustomWidgets_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject PyCustomWidgets::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_PyCustomWidgets.data,
    qt_meta_data_PyCustomWidgets,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PyCustomWidgets::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PyCustomWidgets.stringdata0))
