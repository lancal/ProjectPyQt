...
#line 29 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtSql/sipQtSqlQSqlRelation.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/Users/alan/PycharmProjects/ProjectPyQt/PyQt5_gpl-5.11.3/QtSql/sipQtSqlQSqlRelation.cpp"
...
PyDoc_STRVAR(doc_QSqlRelation_swap, "swap(self, QSqlRelation)");

extern "C" {static PyObject *meth_QSqlRelation_swap(PyObject *, PyObject *);}
static PyObject *meth_QSqlRelation_swap(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ9", &sipSelf, sipType_QSqlRelation, &sipCpp, sipType_QSqlRelation, &a0))
        {
            sipCpp->swap(*a0);
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QSqlRelation, sipName_swap, doc_QSqlRelation_swap);
...
static PyMethodDef methods_QSqlRelation[] = {
    ...
    {SIP_MLNAME_CAST(sipName_swap), meth_QSqlRelation_swap, METH_VARARGS, SIP_MLDOC_CAST(doc_QSqlRelation_swap)},
